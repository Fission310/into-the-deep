...
public class PIDFController {
     ...
     * includes a feed-forward value which is useful for fighting friction and
     * gravity.
     * Our errorVal represents the return of e(t) and prevErrorVal is the previous
     * error.
     *
     * @param sp The setpoint of the pid control loop.
     * @param pv The measured value of he pid control loop. We want sp = pv, or to
     *           the degree
