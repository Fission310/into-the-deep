...
public class Wrist extends Mechanism {
    ...
    public static double INTAKE_DOWN_ABIT = 0.009;
    public static double BASKET_DOWN_ABIT = -0.12;
    public static double[][] AUTO_INTAKE_POS =  { { 0.5175, 0.5175 }, { 0.59, 0.58 }, { 0.59, 0.58 }, { 0.59, 0.58 } };
    public static double[][] AUTO_INTAKE_LL_POS =  { { .53, 0.48 }, { 0.59, 0.58 }, { 0.59, 0.58 }, { 0.59, 0.58 } };
    public static double[][] AUTO_BASKET_POS =  { { .7, 0.315 }, { 0.59, 0.58 }, { 0.59, 0.58 }, { 0.59, 0.58 } };
    public static double[][] AUTO_MID_POS =  { { .5, 0.460 }, { 0.59, 0.58 }, { 0.59, 0.58 }, { 0.59, 0.58 } };
    public static double[][] INTAKE_POS = { { .53, .53 }, { 0.59, 0.58 }, { 0.59, 0.58 }, { 0.59, 0.58 } };
    public static double[][] INTAKE_MID_POS = { { .6875, 0.330 }, { 0.59, 0.58 }, { 0.59, 0.58 }, { 0.59, 0.58 } };
    public static double[][] INTAKE_SHORT_POS = { { 0.49, 0.49 }, { 0.59, 0.58 }, { 0.59, 0.58 }, { 0.59, 0.58 } };
    public static double[][] INTAKE_DOWN_POS = { { .53, .53 }, { 0.76, 0.53 }, { 0.76, 0.53 }, { 0.76, 0.53 } };
