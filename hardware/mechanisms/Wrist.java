...
public class Wrist extends Mechanism {
    ...
    public static double[][] INTAKE_POS = { { 0.56, 0.33 }, { 0.56, 0.33 }, { 0.56, 0.33 }, { 0.56, 0.33 } };
    public static double[][] INTAKE_DOWN_POS = { { 0.76, 0.53 }, { 0.76, 0.53 }, { 0.76, 0.53 }, { 0.76, 0.53 } };
    public static double[][] FRONT_POS = { { 0.23, 0 }, { 0.23, 0 }, { 0.23, 0 }, { 0.23, 0 } };
    public static double[][] WALL_POS = { { 0.43, 0.42 }, { 0.43, 0.42 }, { 0.43, 0.42 }, { 0.43, 0.42 } };
    public static double[][] BASKET_POS = { { 0.36, 0.13 }, { 0.36, 0.13 }, { 0.36, 0.13 }, { 0.36, 0.13 } };
