...
public class Wrist extends Mechanism {
    ...
    public static double[][] AUTO_INTAKE_POS =  { { 0.535, 0.535 }, { 0.59, 0.58 }, { 0.59, 0.58 }, { 0.59, 0.58 } };
    ...
    public static double[][] INTAKE_DOWN_POS = { { 0.535, 0.535 }, { 0.76, 0.53 }, { 0.76, 0.53 }, { 0.76, 0.53 } };
