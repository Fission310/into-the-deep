...
public class Wrist extends Mechanism {
    ...
    public static double[][] AUTO_INTAKE_POS =  { { 0.475, 0.475 }, { 0.59, 0.58 }, { 0.59, 0.58 }, { 0.59, 0.58 } };
    public static double[][] AUTO_BASKET_POS =  { { 0.37, 0.37 }, { 0.59, 0.58 }, { 0.59, 0.58 }, { 0.59, 0.58 } };
