...
public class Pivot extends Mechanism {
    ...
    public static int AUTO_INTAKE_GRAB_POS = 65;
    public static int RESET_POS = 88;
    public static int RESET_WAIT = 1;
    public static int INIT_POS = 132;
    public static int FRONT_POS = 75;
    public static int INTAKE_UP_POS = 75;
    public static int INTAKE_DOWN_POS = 75;
    public static int INTAKE_GRAB_POS = 75;
