...
public class Pivot extends Mechanism {
    ...
    public static int AUTO_BASKET_POS = 277;
    public static int AUTO_INTAKE_GRAB_POS = 147;
    public static int RESET_POS = 163;
    public static int RESET_WAIT = 1;
    public static int INIT_POS = 207;
    public static int FRONT_POS = 150;
    public static int INTAKE_UP_POS = 150;
    public static int INTAKE_DOWN_POS = 150;
    public static int INTAKE_GRAB_POS = 150;
    public static int WALL_POS = 189;
    public static int BASKET_POS = 277;
    public static int CLIP_POS = 227;
    public static int CLIP_DOWN_POS = 220;
    public static int CLIP_BACK_POS = 259;
    public static int CLIP_BACK_DOWN_POS = 262;
    public static int BACK_POS = 294;
    public static int UP_POS = 260;
    public static int HIGHEST = 247;
    public static int CLIMB_UP_POS = 260;
    public static int CLIMB_DOWN_POS = 180;
