...
public class BasketAuto extends LinearOpMode{
    ...
    private CommandSequence basketSequence = new CommandSequence()
            ...
            .addCommand(s.pivotUp)
            .addWaitCommand(7)
            .addCommand(s.pivotBasket)
            .addCommand(telescopeBasket)
            .addWaitCommand(2)
            .addCommand(s.release)
            .addWaitCommand(0.2)
...
//            .addCommandSequence(basket3Sequence)
    ...
    public void runOpMode() throws InterruptedException {
        ...
        reflect = color == Color.BLUE; // do we need?
