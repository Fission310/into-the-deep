...
public class BasketConstants {
    public Constant FORWARD = new Constant(
            -TILE_LENGTH / 2.0 - 4,
            -WALL_POS + BOT_LENGTH / 2.0 + 7,
            Math.toRadians(90)
    );
    public Constant BASKET = new Constant(
            -TILE_LENGTH * 2.5 + BOT_LENGTH / 2 - 21,
             -TILE_LENGTH * 5 / 2 + BOT_LENGTH / 2 + 0.5,
            Math.toRadians(45)
    );
    public Constant CHAMBER = new Constant(
             0,
                     -TILE_LENGTH,
             UP
             );
    ...
    public Constant BASKET_1 = new Constant(
             -TILE_LENGTH * 2.5 + BOT_LENGTH / 2 - 13,
             - TILE_LENGTH * 5 / 2 + BOT_LENGTH / 2 - 4,
             Math.toRadians(41)
     );
    public Constant BASKET_2 = new Constant(
             -TILE_LENGTH * 2.5 + BOT_LENGTH / 2,
             - TILE_LENGTH * 5 / 2 + BOT_LENGTH / 2,
             Math.toRadians(45)
     );
    public Constant BASKET_3 = new Constant(
             -TILE_LENGTH * 2.5 + BOT_LENGTH/2,
             - TILE_LENGTH * 5 / 2 + BOT_LENGTH / 2,
             Math.toRadians(45)
     );
